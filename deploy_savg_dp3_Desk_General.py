...
def ineraction_policy_inference(camera_hand,camera_overhead, bestman,stage1segmentation,predictor,model_va,allow_gripper_open_flag,visualize):
    ...
    while True:
        ...
        inference_action =  model_va.single_inference(cur_model_observation,visualize=visualize)
...
def mission_execution(camera_hand,camera_overhead, bestman,stage1segmentation,predictor,model_savg,model_va):
    ...
    for subtask in subtasks:
        ...
        if action == "move_towards":
            ...
            allow_gripper_open_flag = ineraction_policy_inference(camera_hand,camera_overhead, bestman,stage1segmentation,predictor,model_va,allow_gripper_open_flag,visualize=visualize)
            if action=="place":
                # Lift Up 5cm
                cur_eff_pose = bestman.get_current_eef_pose()
