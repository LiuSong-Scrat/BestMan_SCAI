...
if USE_SAM2:
    ...
    frame = cv2.imread("/home/liusong/ProgramFiles/BestMan/Dataset/Images/TrashSweep.png")
    ...
    points = np.array([[273, 205],[280,263],[284,286]], dtype=np.float32)
    ...
    points = np.array([[422, 339],[432,400],[437,457]], dtype=np.float32)
    labels = np.array([1,1,1], dtype=np.int32)
    _, out_obj_ids, out_mask_logits = predictor.add_new_prompt(
        frame_idx=ann_frame_idx, obj_id=ann_obj_id, points=points, labels=labels
    )
