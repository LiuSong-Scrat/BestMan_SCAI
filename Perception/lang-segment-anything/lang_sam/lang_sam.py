...
class LangSAM:
    def __init__(self, ckpt_path: Union[str, None],sam_type="sam2.1_hiera_small",  device=DEVICE):
        self.sam_type = sam_type

        self.sam = SAM()
        self.sam.build_model(sam_type, ckpt_path, device=device)
        self.gdino = GDINO()
        self.gdino.build_model("IDEA-Research/grounding-dino-base",device=device)
